...
namespace LINQMethodsSyntaxTaskApp.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Spartans__3213E83FD2F1A5C9");
            ...
            entity.Property(e => e.MarkAchieved)
                .HasMaxLength(10)
                .IsFixedLength()
                .HasColumnName("mark_achieved");
            entity.Property(e => e.Title)
                .HasMaxLength(10)
                .IsFixedLength()
                .HasColumnName("title");
            entity.Property(e => e.UniverityAttended)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("univerity_attended");
        });
